...
@ControllerAdvice
public class KorikeResponseEntityExceptionHandler extends ResponseEntityExceptionHandler{
	...
	@ExceptionHandler(KorikeException.class)
	public final ResponseEntity<Object> handleSmartAutoSafeException(KorikeException ex, WebRequest request) throws Exception {
		...
		logger.error("KorikeException: " + exceptionResponse.toString());
